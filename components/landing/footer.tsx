...
export function Footer(): React.JSX.Element {
  return (
    <footer className="border-t border-neutral-800 bg-neutral-950 py-12">
        ...
        <div>
          ...
          <div className="mt-5 flex gap-4">
            <a
              ...
              className="text-neutral-400 transition hover:text-lime-400"
            >
              <FaLinkedin size={20} />
            </a>
            <a
          ...
          <ul className="mt-4 space-y-3 text-sm text-neutral-400">
            {CONTACT_PHONE_NUMBERS.map((number) => (
              <li key={number} className="flex items-center gap-2">
                <Phone size={16} />
                <a href={`tel:${number.replace(/\s/g, "")}`} className="hover:text-neutral-50">
                  {number}
                </a>
              </li>
            ))}
            <li className="flex items-center gap-2">
              <Mail size={16} />
              <a href={`mailto:${CONTACT_EMAIL}`} className="hover:text-neutral-50">
                {CONTACT_EMAIL}
              </a>
            </li>
          </ul>
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-neutral-900 px-6 pt-6 text-center text-xs text-neutral-600">
